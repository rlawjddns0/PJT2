...
const Cleaning = ({ navigation }) => {
    ...
    return (
        <Container>
            ...
            <IconButton uri={ theme == lightTheme ? images.selection : images.selectionG} title={"부분 청소"} onPress={() => navigation.navigate('Channel Creation')} imgStyle={{height:45, width:45, marginTop:'20%', marginLeft:10}}/>
